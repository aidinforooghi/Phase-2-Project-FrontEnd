# React Toys App
A single-page application built with React, HTML, CSS, and JavaScript. This project incorporates client-side routing, utilizes the Mantine UI library for styling, and interacts with a RESTful API to manage details.
